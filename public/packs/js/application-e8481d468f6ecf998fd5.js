...
$(function () {
  ...
  $(".vote").on("click", ".upvote, .downvote", function () {
    ...
    console.log("upvote for " + post_id); // $(".vote").on("click", ".upvote, .downvote", function() {
    //     var post_id = $(this).parent().data("id"),
...
/* harmony import */ var _includes_vote_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_includes_vote_js__WEBPACK_IMPORTED_MODULE_4__);
...
/******/ });
//# sourceMappingURL=application-e8481d468f6ecf998fd5.js.map