...
Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])(function () {
  ...
  Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])(".vote").on("click", ".upvote", function () {
    var post_id = Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])(this).parent().data("id"),
        is_upvote = Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])(this).hasClass("upvote");
    console.log('upvote for post ' + post_id);
    console.log('is an upvote ' + is_upvote); // $.ajax ({
    //     url: "/post/vote",
    //     method: "POST",
...
/******/ });
//# sourceMappingURL=application-432a239e183a19d9689b.js.map